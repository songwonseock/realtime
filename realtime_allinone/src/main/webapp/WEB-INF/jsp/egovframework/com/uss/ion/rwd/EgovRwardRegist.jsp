...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="9" height="9" hspace="3" style="vertical-align: middle" alt="">&nbsp;포상자</td>
 </tr>
</table>
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="포상자 정보" >
<caption>포상자정보</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="rwardManId">포상자</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  >
        <input name="rwardManNm" id="rwardManNm" type="text" size="20" value="" title="포상자" readonly>
        <form:hidden path="rwardManId"/>
	    <span class="link"><a href="<c:url value='/uss/ion/ism/selectSanctnerListPopup.do'/>" target="_blank"  title="새 창으로 이동"  onClick="fn_egov_schdulCharger_LeaderSchdule_Rward('포상자', 'rwardManId', '', 'rwardManNm', 'rwardManOrgnztNm');return false;">
	    <img src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif' />" alt="검색"  width="15" height="15">
	    </a></span>
    </td>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rwardManOrgnztNm">소속 </label><img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>          
...
<caption>포상 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rwardCd">포상구분</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"  >
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rwardNm">포상명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  ><form:input  path="rwardNm" title="포상명"/></td>
    <th width="20%" height="23" class="required_text" scope="row"><label for="rwardDe">포상일</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td width="30%"  >
  ...
  <tr>
    <th width="20%" height="23" class="required_text" scope="row"><label for="pblenCn">공적사항</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>          
    <td colspan="3"  >
...
<!-- 첨부파일 테이블 레이아웃 설정 Start..-->
  <tr>
	<th width="20%" height="23" class="required_text" scope="row"><label for="file_1">첨부파일</label><img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th>
	<td colspan="3" >
